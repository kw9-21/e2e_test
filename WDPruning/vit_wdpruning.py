...
# 兼容性：torch._six 在某些 torch 版本里不存在，退回到 collections.abc
try:
    from torch._six import container_abcs  # type: ignore
except Exception:
    import collections.abc as container_abcs  # type: ignore
